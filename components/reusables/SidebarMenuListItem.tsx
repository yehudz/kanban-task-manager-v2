...
const SidebarMenuListItem = ({title, active}: SidebarMenuListItemProps)=> {
  return(
    <div data-testid="board-list-item" className={`${styles.boardButton} flex flex-row items-center ${active ? 'bg-purple font-bold' : ''} hover:bg-grey-200 hover:dark:bg-white hover:text-purple`}>
